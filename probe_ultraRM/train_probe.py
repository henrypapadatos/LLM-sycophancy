...
def create_probe(number_of_layers: int, learning_rate: float, use_wandb: bool = False, L2: float = 0, verbose: bool = False):
    ...
    """
    # create a range between 2**12 (input size is 5120 so i have to change the first number from 4096 to 5120) and 2**0 (output size is 1) with number_of_layers elements
